...
class AppConfig {
  ...
  // Feature Flags
  static const bool enableVoiceInteraction =
      bool.fromEnvironment('ENABLE_VOICE', defaultValue: true);
  static const bool enableAIChat =
      bool.fromEnvironment('ENABLE_AI_CHAT', defaultValue: true);
  static const bool enableRealTimeData =
      bool.fromEnvironment('ENABLE_REALTIME', defaultValue: true);
