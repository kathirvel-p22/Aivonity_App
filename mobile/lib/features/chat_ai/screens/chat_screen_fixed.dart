...
/// - Smart suggestions
/// - Dynamic gradients
class ChatScreenFixed extends ConsumerStatefulWidget {
  const ChatScreenFixed({super.key});

  @override
  ConsumerState<ChatScreenFixed> createState() => _ChatScreenFixedState();
}

class _ChatScreenFixedState extends ConsumerState<ChatScreenFixed>
